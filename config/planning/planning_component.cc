...
bool PlanningComponent::Proc(
  ...
  /*
  // inject : null_obstacles_plan_in
  local_view_.prediction_obstacles = std::make_shared<prediction::PredictionObstacles>();
  */
  ...
  /*
  // inject : null_obstacles_plan_out
  ADCTrajectory empty_trajectory_pb;
  common::util::FillHeader(node_->Name(), &empty_trajectory_pb);
  planning_writer_->Write(empty_trajectory_pb);
  history->Add(empty_trajectory_pb);
  //history->Add(adc_trajectory_pb);
  */
