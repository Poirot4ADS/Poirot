...
class RTKLocalizationComponent final
 ...
 private:
  ...
  double linear_velocity_offset_;
  double linear_acceleration_offset_;
  double angular_velocity_offset_;
  double euler_angles_offset_;
  bool result_fault_injection_;
  bool use_ideal_module_data_;
  bool use_ideal_component_data_;
  bool use_gps_component_;
  bool use_imu_component_;
  bool use_corrected_imu_component_;
  std::shared_ptr<cyber::Reader<localization::CorrectedImu>>
      corrected_imu_listener_ = nullptr;
  std::shared_ptr<cyber::Reader<LocalizationEstimate>> localization_gt_listener_ =
      nullptr;
  ...
  std::string localization_gt_topic_ = "";
