 ...
 */
 ...
 class PredictionComponent
  ...
  public:
   ...
   bool use_priority_component_;
   bool use_interaction_component_;
   bool use_trajectory_component_;
   bool result_fault_injection_;
   double path_point_offset_;
   double theta_offset_;
   double v_offset_;
   double a_offset_;
   const TopicConf& topic_conf() const;
   double priority_offset_;
   double interaction_offset_;
   bool use_ideal_module_data_;
   bool use_ideal_component_;
   /**
    * @brief Destructor
    */
   ~PredictionComponent();
